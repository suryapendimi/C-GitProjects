/*
//The controller is a regular JavaScript function. It is called once when AngularJS runs into the n-controller declarration.
...
angular.module("InlineEditorModule", []).controller("InlineEditorController", function InlineEditorController($scope) {
