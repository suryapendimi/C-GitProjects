angular.module("mainModule", [])
  .controller("mainController", function ($scope, $http, jsonFilter) {
      ...
      $scope.simpleGetCall = function (withSuccess) {
          var callURL = (withSuccess ? "http://localhost:50540/api/contacts" : "invalid-url.php");
      ...
      $scope.getCall = function () {
          ...
          $http.get("http://localhost:50540/api/contacts", config)
            .success(function (data, status, headers, config) {
      ...
      $scope.putCall = function () {
          ...
          $http.put("http://localhost:50540/api/contacts", $scope.putData, config)
            .success(function (data, status, headers, config) {
      ...
      $scope.deleteCall = function () {
          ...
          $http.delete("http://localhost:50540/api/contacts", config)
            .success(function (data, status, headers, config) {
      ...
      $scope.headCall = function () {
          ...
          $http.head("http://localhost:50540/api/contacts", config)
            .success(function (data, status, headers, config) {
